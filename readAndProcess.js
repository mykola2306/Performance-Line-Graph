...
function LoadFile() {
    ...
    for (var j = 0; j < allUsers.length; j++) {
        ...
        //checking if member participated more than 50 times
        if(times.length > 50){
            members.push({
                x: times,
                y: userScore,
